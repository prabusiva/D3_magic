...
This chart shows the relative frequency of letters in the English language. A vertical bar chart such as this is sometimes called a *column* chart. Data: *Cryptological Mathematics*, Robert Lewand`
  ...
  main.variable(observer("chart")).define("chart", ["BarChart","alphabet","d3","width"], function(BarChart,alphabet,d3,width){return(
BarChart(alphabet, {
  x: d => d.letter,
  y: d => d.frequency,
  ...
  main.variable(observer("alphabet")).define("alphabet", ["FileAttachment"], function(FileAttachment){return(
